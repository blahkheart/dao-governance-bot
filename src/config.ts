...
const HISTORIC_EVENTS_START_BLOCK = process.env.HISTORIC_EVENTS_START_BLOCK!;
const HTTP_RPC_URL = process.env.HTTP_RPC_URL!;

if (!FARCASTER_BOT_MNEMONIC || !SIGNER_UUID || !NEYNAR_API_KEY || !MONGODB_URI || !DAO_GOVERNOR_ADDRESS || !ERC20_ADDRESS || !HISTORIC_EVENTS_START_BLOCK || !HTTP_RPC_URL) {
